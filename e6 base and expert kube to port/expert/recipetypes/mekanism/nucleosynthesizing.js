ServerEvents.recipes(event => {
    ...
    */
    var data = {
        recipes: [
            ...
            },
            {
                ...
                itemInput: { ingredient: { item: /*'astralsorcery:'*/ 'kubejs:replaceme' } },
                gasInput: { amount: 2, gas: 'mekanism:antimatter' },
                duration: 500,
            ...
            },
            {
                ...
                itemInput: { ingredient: { item: /*'atum:'*/ 'kubejs:replaceme' } },
                gasInput: { amount: 2, gas: 'mekanism:antimatter' },
                duration: 500,
    ...
    data.recipes.forEach((recipe) => {
        // console.log(`Adding recipe: ${recipe.id}, output: ${recipe.output}, index: ${data.recipes.indexOf(recipe)}`)
