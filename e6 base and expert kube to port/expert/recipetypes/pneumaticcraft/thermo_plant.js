ServerEvents.recipes(event => {
    ...
    const recipes = [
        ...
        */
        ...
        {
            item_input: { item: /*'atum:'*/ 'kubejs:replaceme' },
        ...
        },
        {
            ...
            item_output: { item: 'emendatus:lithium_dust', count: 1 },
            pressure: 2.0,
            exothermic: true,
        ...
        },
        {
            fluid_input: {
                ...
                fluid: /*'resourcefulbees:'*/ 'kubejs:replaceme',
                amount: 250
            },
        ...
        {
            fluid_input: { type: 'pneumaticcraft:fluid', fluid: /*'astralsorcery:'*/ 'kubejs:replaceme', amount: 1000 },
            item_input: { item: 'kubejs:astrogro' },
            item_output: { item: /*'astralsorcery:'*/ 'kubejs:replaceme', count: 1 },
            pressure: 4.5,
            exothermic: true,
            speed: 0.1,
    ...
    crystal_colors.forEach((crystal_color) => {
        recipes.push({
            ...
            item_input: { item: `quark:${crystal_color}_corundum_cluster` },
