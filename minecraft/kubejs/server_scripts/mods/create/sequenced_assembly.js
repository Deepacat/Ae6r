ServerEvents.recipes(e => {
    // placeholder variable, used to set as the transitional item before recipes so they're easier to read
    let transitional
    ...
    ).id('kubejs:create/sequenced_assembly/book_from_leather')
    ...
    ).id('kubejs:create/sequenced_assembly/book_from_pattern')
    ...
    ).id('kubejs:create/sequenced_assembly/cokebricks')
    ...
    ).id('kubejs:create/sequenced_assembly/blastbricks')
    ...
    ).id('kubejs:create/sequenced_assembly/alloybricks')
    ...
    ).id('kubejs:create/sequenced_assembly/backplane_alternate')
    ...
    ).id('kubejs:create/sequenced_assembly/engineering_student_meals')
    ...
    ).id('kubejs:create/sequenced_assembly/building_materials')
    ...
    ).id('kubejs:create/sequenced_assembly/landscaping_materials')
    ...
    ).id('kubejs:create/sequenced_assembly/construction_tools')
    ...
    ).id('kubejs:create/sequenced_assembly/foundation_materials')
    ...
    ).id('kubejs:create/sequenced_assembly/computer_package')
    ...
    ).id('kubejs:create/sequenced_assembly/big_box_o_boom')
    ...
    ).id('kubejs:create/sequenced_assembly/mimirs_memory_box')
    ...
    ).id('kubejs:create/sequenced_assembly/box_of_thankful_dinners')
    ...
    ).id('kubejs:create/sequenced_assembly/stim_pack')
    ...
    ).id('kubejs:create/sequenced_assembly/treated_arcane_handle')
    ...
    ).id('kubejs:create/sequenced_assembly/charged_certus_steel_ingot')

    transitional = 'immersiveengineering:circuit_board'
    e.recipes.create.sequenced_assembly('kubejs:silicon_base', 'immersiveengineering:circuit_board',
        [
            e.recipes.create.filling(transitional, [transitional, Fluid.of('tconstruct:molten_tin', 90)]),
            e.recipes.create.deploying(transitional, [transitional, 'ae2:silicon']),
            e.recipes.create.pressing(transitional, transitional),
            e.recipes.create.deploying(transitional, [transitional, 'ae2:silicon_press']).keepHeldItem(),
        ]
    ).transitionalItem(transitional)
        .loops(1)
        .id('kubejs:create/sequenced_assembly/silicon_base')
})
