ServerEvents.recipes(e => {
    ...
    ).id(`kubejs:immersive_engineering/alloy_kiln/alloy/froststeel_ingot_3`)
    ...
    ).id(`kubejs:immersive_engineering/alloy_kiln/blueprint_components`)
    ...
    ).id(`kubejs:immersive_engineering/alloy_kiln/enchanted_golden_apple`)
    ...
    ).id(`kubejs:immersive_engineering/alloy_kiln/helmet_tome`)
    ...
    ).id(`kubejs:immersive_engineering/alloy_kiln/chestplate_tome`)
    ...
    ).id(`kubejs:immersive_engineering/alloy_kiln/pickaxe_tome`)

    e.recipes.immersiveengineering.alloy('16x apotheosis:weapon_tome',
        '16x minecraft:book',
        Item.of('mekanismtools:lapis_lazuli_sword', { Damage: 0 }).weakNBT()
    ).id(`kubejs:immersive_engineering/alloy_kiln/weapon_tome`)

    e.recipes.immersiveengineering.alloy('16x apotheosis:scrap_tome',
        '16x minecraft:book',
        'tconstruct:ender_slime_crystal'
    ).id(`kubejs:immersive_engineering/alloy_kiln/scrap_tome`)

    e.recipes.immersiveengineering.alloy('16x apotheosis:other_tome',
        '16x minecraft:book',
        'tconstruct:sky_slime_crystal'
    ).id(`kubejs:immersive_engineering/alloy_kiln/other_tome`)

    e.recipes.immersiveengineering.alloy('2x thermal:enderium_ingot',
        '2x #forge:ingots/terminite',
        '#forge:dusts/diamond'
    ).id(`kubejs:immersive_engineering/alloy_kiln/enderium_ingot`)
    
    e.recipes.immersiveengineering.alloy('2x thermal:enderium_block',
        '2x #forge:storage_blocks/terminite',
        '9x #forge:dusts/diamond'
    ).id(`kubejs:immersive_engineering/alloy_kiln/enderium_block`)
    
    e.recipes.immersiveengineering.alloy('3x modularrouters:puller_module_1',
        '3x modularrouters:blank_module',
        '3x kubejs:replaceme'
    ).id(`kubejs:immersive_engineering/alloy_kiln/puller_module_1`)

    e.recipes.immersiveengineering.alloy('3x modularrouters:sender_module_1',
        '3x modularrouters:blank_module',
        '3x kubejs:replaceme'
    ).id(`kubejs:immersive_engineering/alloy_kiln/sender_module_1`)

    e.recipes.immersiveengineering.alloy('3x modularrouters:fluid_module',
        '3x modularrouters:blank_module',
        '3x kubejs:replaceme'
    ).id(`kubejs:immersive_engineering/alloy_kiln/fluid_module`)

    e.recipes.immersiveengineering.alloy('3x modularrouters:energy_output_module',
        '3x modularrouters:blank_module',
        'thermal:charge_bench'
    ).id(`kubejs:immersive_engineering/alloy_kiln/energy_output_module`)

    e.recipes.immersiveengineering.alloy('2x kubejs:pigmented_bricks', 
        '2x kubejs:marl',
        'hexcasting:dye_colorizer_black'
    ).id(`kubejs:immersive_engineering/alloy_kiln/pigmented_bricks`)

    e.recipes.immersiveengineering.alloy('4x kubejs:crystal_glass',
        '4x glassential:glass_ghostly',
        'quark:white_corundum_cluster'
    ).id(`kubejs:immersive_engineering/alloy_kiln/crystal_glass_cluster`)

    e.recipes.immersiveengineering.alloy('3x kubejs:crystal_glass',
        '3x glassential:glass_ghostly',
        'quark:white_corundum'
    ).id(`kubejs:immersive_engineering/alloy_kiln/crystal_glass_block`)
})