ServerEvents.recipes(e => {  
    ...
    e.recipes.thermal.chiller('undergarden:forgotten_ingot',
        ...
        .energy(5000)
        .id('kubejs:thermal/machines/chiller/forgotten_ingot')
    ...
    e.recipes.thermal.chiller('undergarden:forgotten_nugget',
        ...
        .energy(555)
        .id('kubejs:thermal/machines/chiller/forgotten_nugget')
    ...
    e.recipes.thermal.chiller('mekanism:ingot_refined_obsidian',
        ...
        .energy(5000)
        .id('kubejs:thermal/machines/chiller/mekanism_ingot_refined_obsidian')
    ...
    e.recipes.thermal.chiller('mekanism:nugget_refined_obsidian',
        ...
        .energy(555)
        .id('kubejs:thermal/machines/chiller/mekanism_nugget_refined_obsidian')
    ...
    e.recipes.thermal.chiller('mekanism:ingot_refined_glowstone',
        ...
        .energy(5000)
        .id('kubejs:thermal/machines/chiller/mekanism_ingot_refined_glowstone')
    ...
    e.recipes.thermal.chiller('mekanism:nugget_refined_glowstone',
        ...
        .energy(555)
        .id('kubejs:thermal/machines/chiller/mekanism_nugget_refined_glowstone')
