...
ServerEvents.tags('item', e => {
    ...
    // Immersive engineering recycling recipe generation blacklist tag. what a mouthful
    e.add('immersiveengineering:recycling/blacklist', [
        '#forge:gears' // prevent gears from getting autogenerated recycling recipes (Odd behavior since all gears can be crafted with other plates and nuggets)
    ])
})
