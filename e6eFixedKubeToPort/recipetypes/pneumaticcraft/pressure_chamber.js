ServerEvents.recipes(event => {
    ...
    const recipes = [
        ...
        },
        {
            ...
            pressure: 1.5,
            results: [{ item: /*'betterendforge:'*/ 'kubejs:replaceme', count: 1 }],
            id: `${id_prefix}dense_snow`
        },
        {
            inputs: [{ item: /*'betterendforge:'*/ 'kubejs:replaceme', count: 4 }],
            pressure: 1.5,
        ...
        },
        {
            inputs: [
                ...
                { item: /*'refinedstorage:'*/ 'kubejs:replaceme', count: 4 },
                { item: 'tconstruct:seared_brick', count: 4 },
                { item: 'thermal:machine_frame', count: 1 }
            ],
            pressure: 2.5,
            results: [{ item: /*'refinedstorage:'*/ 'kubejs:replaceme', count: 2 }],
        ...
        },
        {
            inputs: [
                ...
                { item: /*'refinedstorage:'*/ 'kubejs:replaceme', count: 2 },
                { item: 'powah:dielectric_paste', count: 1 },
        ...
        },
        {
            inputs: [
                ...
                { item: /*'refinedstorage:'*/ 'kubejs:replaceme', count: 1 },
        ...
        },
        {
            ...
            pressure: 2.0,
            results: [{ item: /*'refinedstorage:'*/ 'kubejs:replaceme', count: 1 }],
            id: /*'refinedstorage:'*/ 'kubejs:replaceme'
        },
        {
            inputs: [
        ...
        {
            inputs: [
                { item: /*'astralsorcery:'*/ 'kubejs:replaceme', count: 1 },
        ...
        },
        {
            inputs: [
                ...
                { item: /*'prettypipes:'*/ 'kubejs:replaceme', count: 10 },
        ...
        },
        {
            inputs: [
                ...
                { item: /*'prettypipes:'*/ 'kubejs:replaceme', count: 5 },
    ...
    recipes.forEach((recipe) => {
        // console.log(`Adding recipe: ${recipe.id}, output: ${recipe.results}, index: ${recipes.indexOf(recipe)}`)
        let ingredients = []
