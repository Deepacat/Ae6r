ServerEvents.recipes(event => {
    ...
    const recipes = [
        ...
        },
        {
            ...
            processingTime: 600,
            outputItem: { item: 'botanypots:terracotta_botany_pot', count: 1 },
            outputFluid: '',
            outputFluidAmount: 0,
            id: 'botanypots:crafting/terracotta_botany_pot'
        },
        {
            inputs: [
            ...
            inputFluid: /* 'materialis:' */ 'kubejs:replaceme',
            inputFluidAmount: 1296,
            processingTime: 600,
            outputItem: { item: 'botanypots:terracotta_hopper_botany_pot', count: 1 },
            outputFluid: '',
            outputFluidAmount: 0,
            id: 'botanypots:crafting/terracotta_hopper_botany_pot'
        },
        {
            inputs: [
        ...
        },
        {
            ...
            inputFluidAmount: 1296,
            processingTime: 400,
            outputItem: { item: /* 'rsinfinitybooster:' */ 'kubejs:replaceme', count: 1 },
            outputFluid: '',
            outputFluidAmount: 0,
            id: /* 'rsinfinitybooster:' */ 'kubejs:replaceme'
        },
        {
            inputs: [
                /* 'rsinfinitybooster:' */ 'kubejs:replaceme',
        ...
        },
        {
            ...
            inputFluidAmount: 1000,
            processingTime: 200,
            outputItem: { item: 'mekanismgenerators:module_solar_recharging_unit', count: 1 },
            outputFluid: '',
            outputFluidAmount: 0,
        ...
        {
            inputs: [/*'extrastorage:'*/ 'kubejs:replaceme'],
            inputFluid: 'tconstruct:molten_netherite',
            inputFluidAmount: 144 * 9,
            processingTime: 200,
            outputItem: { item: /*'extrastorage:'*/ 'kubejs:replaceme', count: 1 },
            outputFluid: '',
            outputFluidAmount: 0,
            id: /*'extrastorage:'*/ 'kubejs:replaceme'
        },
        {
            inputs: [
        ...
        },
        {
            ...
            inputFluid: /*'astralsorcery:'*/ 'kubejs:replaceme',
            inputFluidAmount: 100,
            processingTime: 20,
            outputItem: { item: /*'astralsorcery:'*/ 'kubejs:replaceme', count: 2 },
            outputFluid: '',
            outputFluidAmount: 0,
        ...
        recipes.push(
            {
                ...
                inputFluidAmount: 8000,
                processingTime: 600,
                outputItem: { item: `botanypots:${color}_terracotta_botany_pot`, count: 1 },
                outputFluid: '',
                outputFluidAmount: 0,
                id: `botanypots:crafting/${color}_terracotta_botany_pot`
            },
            {
                inputs: [
                    'ars_nouveau:whirlisprig_charm',
                ...
                inputFluidAmount: 1296,
                processingTime: 600,
                outputItem: { item: `botanypots:${color}_terracotta_hopper_botany_pot`, count: 1 },
                outputFluid: '',
                outputFluidAmount: 0,
                id: `botanypots:crafting/${color}_terracotta_hopper_botany_pot`
            }
        )
    })

    recipes.forEach((recipe) => {
        // console.log(`Adding recipe: ${recipe.id}, output: ${recipe.outputItem}, index: ${recipes.indexOf(recipe)}`)
