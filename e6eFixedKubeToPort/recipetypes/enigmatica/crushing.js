ServerEvents.recipes(event => {
    ...
    const recipes = [
        ...
        {
            secondary_output: Item.of('kubejs:basalt_powder').withChance(0.5),
        ...
        {
            secondary_output: Item.of('minecraft:bone_meal').withChance(0.15),
        ...
        {
            secondary_output: Item.of('waystones:warp_dust').withChance(0.15),
    ...
    let recipetypes_crushing = (event, recipe) => {
        ...
        //         fluidInput: /*'astralsorcery:'*/ 'kubejs:replaceme',
        //         input: recipe.input,
    ...
    recipes.forEach((recipe) => {
        // console.log(`Adding recipe: ${recipe.id_suffix}, output: ${recipe.output}, index: ${recipes.indexOf(recipe)}`)
