ServerEvents.recipes(event => {
    // console.log('running occultism:ritual recipes')
    ...
    const recipes = [
        ...
        },
        {
            ...
            ingredients: [
                ...
                'quark:gold_bars',
                /*'betterendforge:'*/ 'kubejs:replaceme',
                Item.of(/*'betterendforge:'*/ 'kubejs:replaceme').weakNBT(),
        ...
        {
            ritual_type: 'occultism:craft',
            activation_item: /* 'materialis:' */ 'kubejs:replaceme',
            pentacle_id: 'occultism:craft_marid',
            duration: 60,
            entity_to_sacrifice: {
        ...
        },
        {
            ...
            entity_to_summon: /*'atum:'*/ 'kubejs:replaceme',
        ...
        },
        {
            ...
            result: /*'astralsorcery:'*/ 'kubejs:replaceme',
        ...
        },
        {
            ...
            ingredients: [
                'occultism:magic_lamp_empty',
                Item.of(/*'atum:'*/ 'kubejs:replaceme').weakNBT(),
        ...
        },
        {
            ...
            result: /* 'masterfulmachinery:' */ 'kubejs:replaceme',
    ...
    */
    let mycelial_generators = [
        ...
        { name: 'potion', ingredients: [/*'atum:anputs_fingers_spores'*/ 'kubejs:replaceme', 'botania:brewery'] },
    ...
    // console.log(`Adding ${recipes.length} occultism:ritual recipes`)
    recipes.forEach((recipe) => {
        // console.log(`Adding recipe: ${recipe.id}, output: ${recipe.result}, index: ${recipes.indexOf(recipe)}`)
