    ...
    const recipes = [
        {
            ...
            outputs: ['emendatus:coke_gem', 'thermal:tar', Fluid.of('immersiveengineering:creosote', 250)],
            energy: 12000,
        ...
        },
        {
            ...
            outputs: ['emendatus:coke_gem', 'thermal:tar', Fluid.of('thermal:heavy_oil', 50)],
            energy: 12000,
